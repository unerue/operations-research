...
class RANDAlgorithm:
    ...
    """
    def __init__(
        self, di: int, sw: int, swi: float, 
        hwi: float, sri: float, hri: float, 
        m: int = 10, verbose: bool = True
        ):
        self.di = di
        self.sw = sw
        self.swi = swi
    ...
    def optimize(self):
        ...
        j = 1
        self.best_total: float = np.inf
        self.best_ki: float = 0.0
        self.best_fi: float = 0.0
        best_solution: float = 0.0
        while True:
            r = 0
